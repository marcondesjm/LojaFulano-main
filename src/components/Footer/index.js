...
function Footer () {
    return(
        <footer className='footer-container'>
          ...
          <p>DESIGN POR: <a href='http://vstectity.com/' target='_blank'><strong>CON3CT4NDO</strong></a></p>
          <p>PROGRAMAÇÃO POR: <a href='https://yurerafael.dev/' target='_blank'> <strong>Marcondes J. Machado</strong></a></p>
          </div>
        </footer>
    )
}
