...
import image1 from '../../../../../images/produtos/cabo-macaw.png'

export default function Macaw () {
    ...
    return(
        <div>
         ...
         <div className='container-cable-aviator'>
            ...
            <p className='name-product-cable-aviator-sakura'>Cabo Enrolado Aviator - Modelo Macaw </p>
